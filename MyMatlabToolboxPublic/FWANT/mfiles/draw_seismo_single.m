...
%cmp{end+1}= 'Ux'; cmp0{end+1}='1'; cmp1{end+1}='( 10)';
%cmp{end+1}= 'Uy'; cmp0{end+1}='1'; cmp1{end+1}='( 10)';
%cmp{end+1}= 'Uz'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';

%cmp{end+1}= 'Uz'; cmp0{end+1}='1'; cmp1{end+1}='( 10)';

%cmp{end+1}= 'Vx'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';
%cmp{end+1}= 'Vy'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';
cmp{end+1}= 'Vz'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';

%cmp{end+1}= 'Txx'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';
%cmp{end+1}= 'Tyy'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';
%cmp{end+1}= 'Tzz'; cmp0{end+1}='1'; cmp1{end+1}='( 1)';
ncmp=numel(cmp);
...
ryid(end+1)= 1; stid(end+1)= 576+50-25*10;spec_line='r';
%ryid(end+1)= 1; stid(end+1)= 25*(5+10)+1;spec_line='m';
%ryid(end+1)= 1; stid(end+1)= 25*(5+5)+1;spec_line='b';
%ryid(end+1)= 1; stid(end+1)= 25*(5+2)+1;spec_line='m';
%ryid(end+1)= 1; stid(end+1)= 25*(5+3)+1;spec_line='b';
